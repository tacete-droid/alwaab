...
<template>
    <button
        ...
        :aria-label="isDark ? t('layout.theme_light') : t('layout.theme_dark')"
        @click="toggleTheme"
    >
        <svg v-if="isDark" class="h-[18px] w-[18px]" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
